...
artistsArray.push(new Artist("Chancelor Bennett", "(Chance the Rapper)", ["Boss DM-2 Analog Delay", "Boss PH-1 Phaser", "Boss DC-2 Dimension C", "EarthQuaker Devices Hoof-Reaper Fuzz", "Mr. Black Eterna Shimmer Reverb"], "img/artists/ChanceTheRapper.jpg", "Chancelor Bennett , known professionally as Chance the Rapper, is an American rapper, singer, songwriter, record producer and actor from the West Chatham neighborhood of Chicago, Illinois. In 2013, he began to gain recognition following the release of his second mixtape, Acid Rap. He has worked as the lead vocalist for the band The Social Experiment; they released the album Surf in May 2015. In May 2016, Bennett released his third mixtape Coloring Book to critical acclaim. It earned him three Grammy awards, including for Best Rap Album."));
...
usersArray.push(new User("Zachary Marston", "Epicodus", "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", ["Boss RV-3 Reverb/Delay", "Zvex Lo-Fi Loop Junky", "Klon Centaur"], ["Donald Glover", "Chancelor Bennett", "Austin Post", "Dieuson Octave", "Jahseh Onfroy", "Michael White", "Shayaa Abraham-Joseph"]));

usersArray.push(new User("Rick Sanchez", "Wubalubs", "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut laa. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", ["Boss GE-7 Equalizer", "Boss DS-1 Distortion"], ["Kevin Shields", "Kevin Parker"]));

usersArray.push(new User("Tim Richardson", "The NoNos", "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", ["Zvex Lo-Fi Loop Junky", "Boss RV-3 Reverb/Delay"], ["Kevin Shields", "Kevin Parker", "Rob Crow"]));
...
usersArray.push(new User("Voy Boy", "", "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", ["Zvex Lo-Fi Loop Junky"], ["Ty Segall", "Greta Kline", "Courtney Barnett", "Chelsea Wolfe"]));

usersArray.push(new User("Bill Nye", "", "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", ["Boss DS-1 Distortion"], ["Rob Crow", "Frank Zappa"]));

usersArray.push(new User("Elon Musk", "", "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", ["Electro-Harmonix Small Stone", "Zvex Lo-Fi Loop Junky"], ["Kurt Vile"]));

usersArray.push(new User("Steve Rodgers", "", "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", ["Zvex Lo-Fi Loop Junky", "Boss PN-2 Tremolo/Pan",], ["Corin Tucker", "Kevin Parker"]));

usersArray.push(new User("Tyler Bussanich", "", "Bacon ipsum dolor amet andouille corned beef landjaeger pig prosciutto jerky capicola leberkas short loin kielbasa tongue kevin venison frankfurter. Pork meatloaf turducken ball tip sirloin shankle salami. Shank capicola doner ball tip brisket tail bresaola flank jerky porchetta pork loin jowl drumstick. Ground round ribeye pork belly tenderloin tri-tip short ribs fatback pastrami andouille. Pork chop drumstick tail swine sausage filet mignon ball tip doner pork loin fatback bacon rump sirloin. Biltong ribeye kielbasa jerky pork belly sausage.", ["Boss DS-1 Distortion", "Boss BD-2 Blues Driver"], ["Kurt Vile", "Kevin Parker", "Rob Crow"]))

usersArray.push(new User("Adam Smith", "Silver Medal", "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.", ["Boss DC-2 Dimension C", "Boss VB-2 Vibrato", "Electro-Harmonix Memory Man", "EarthQuaker Devices Hoof-Reaper Fuzz", "Empress Reverb", "Fairfield Circuitry Meet Maude LO-FI Analog Delay", "Strymon El Capistan", "Sonic Research ST-300 Turbo Tuner", "Diamond Compressor", "Electro-Harmonix Small Stone", "Boss PN-2 Tremolo/Pan"], ["Melina Duterte", "Kevin Shields", "Nels Cline", "Chelsea Wolfe", "Liz Harris"]));
...
function makeUserOutput(foundUser) {
  $('#info-output').html('<div class="removable-main">' +
                            '<li>' + foundUser.name + ' : ' + foundUser.group + '</li>' +
