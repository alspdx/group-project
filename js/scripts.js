...
pedalsArray.push(new Pedal ("DigiTech Whammy DT", "Electro-Harmonix", "Chorus", "http://www.effectsdatabase.com/model/eh/smallclone", 'img/pedals/EHXSmallClone.png', "The classic chorus! Analog chorus pedal popularized by Kurt Cobain. The finest analog chorus sounds: from clear, rich and dimensional to warm pulsating warbles, can be intensified with the Depth Control. Simple tweaks generate exciting doubling effects. Chiming 12-string tone, or Leslie-like warbles."));
...
pedalsArray.push(new Pedal ('EarthQuaker Devices Dispatch Master Delay/Reverb', 'EarthQuaker Devices', 'Delay', 'http://www.effectsdatabase.com/model/earthquaker/dispatchmaster', 'img/pedals/EQDDispatchMaster.png', 'When you want an amazing reverb and an amazing delay but can\'t afford both, the Dispatch Master is the solution to your problems. This versatile delay/reverb features up to 2000ms of delay time, separate controls for delay and reverb with the option to run both effects simultaneously and an all-analog direct signal path.'));
